package com.spider.common.datasource;
...
@DataSource("spider_db")
public class SpiderDataSourceFactory implements BaseDataSource{
	private Properties CONFIG_PROPS = PropsUtil.loadProps("spider_db.properties");
	...
	public SpiderDataSourceFactory() {
        //#初始化jdbc配置
